...
function TestClasses:testClasses()
	local obj = class.new("rd/Resource", "resource_name")
	lu.assert(obj)
	lu.assertEquals(obj:getName(), "resource_name")

	local network1 = class.new("rd/ResourceNetwork", 1)
	local network2 = class.new("rd/ResourceNetwork", 2)
	local network3 = class.new("rd/ResourceNetwork", 3)
	local ent1 = class.new("rd/ResourceEntity", 10)
	local ent2 = class.new("rd/ResourceEntity", 11)
	local ent3 = class.new("rd/ResourceEntity", 12)
	local ent4 = class.new("rd/ResourceEntity", 13)
	local ent5 = class.new("rd/ResourceEntity", 14)
	local ent6 = class.new("rd/ResourceEntity", 15)
